...
```{r fig1, dpi = 720, fig.align="center", echo = FALSE, warning = FALSE, message=FALSE}
  df %>%
...
```{r fig2, dpi = 720, fig.align="center", echo = FALSE, warning = FALSE, message=FALSE}
 df %>%
...
``` {r fig3, dpi = 720, fig.align="center", echo = FALSE, warning = FALSE, message=FALSE}
jfr %>%
...
``` {r fig4, dpi = 720, fig.align="center", echo = FALSE, warning = FALSE, message=FALSE}
unem %>%
...
``` {r fig5, dpi = 720, fig.align="center", echo = FALSE, warning = FALSE, message=FALSE}
data %>%
...
Calculating this measure from BLS aggregate unemployment duration flows allows us to look at a longer view of the job finding probability in Figure 6. 

```{r fig6, dpi = 720, fig.align="center", echo = FALSE, warning = FALSE, message=FALSE }
data %>%
...
```{r fig7, dpi = 720, fig.align="center", echo = FALSE, warning = FALSE, message=FALSE }
data %>%
  filter(date <= "2020-02-01") %>%
  ...
  group_by(decade) %>% 
  filter(decade != 2020) %>%
  ggplot(aes(as.factor(decade), sf), fill = decade) +
  geom_violin(scale = "count") + 
  geom_jitter(aes(y = sf), width = 0.25, size = 0.5, colour = "#313435") + 
